...
function MovableBody(mass, coords, velocity, isRepeller) {
    ...
    this.calcForceFromOther = function (other) {
        ...
        //        force.x = gravity*this.mass*other.mass / Math.pow(distance.x, 2);
        //        force.y = gravity*this.mass*other.mass / Math.pow(distance.y, 2);
...
//MovableBody.prototype = new Body();
